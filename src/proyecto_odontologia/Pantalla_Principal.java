...
public class Pantalla_Principal extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        /*if(Calendario.jCalendar1.getDate()==null){
            JOptionPane.showMessageDialog(this, "Selecciona una Fecha", "Error", JOptionPane.ERROR_MESSAGE);
        }else{
            String formatofecha = "dd MMMM yyyy";
            Date mifecha = Calendario.jCalendar1.getDate();
            SimpleDateFormat formateador = new SimpleDateFormat(formatofecha);
            JOptionPane.showMessageDialog(this," La fecha seleccionada es: "+formateador.format(mifecha), "Info",JOptionPane.ERROR_MESSAGE);
        }*/
