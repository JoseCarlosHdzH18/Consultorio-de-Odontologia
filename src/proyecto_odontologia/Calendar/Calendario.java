    ...
    private void jCalendar1PropertyChange(java.beans.PropertyChangeEvent evt) throws ParseException {     
        ...
        try {
            ...
            while(resultado.next()){
                ...
                String fecha_sel_mod = procesamiento_fecha(fecha_seleccionada);
                ...
                if(fecha_Mysql.equals(fecha_sel_mod)){
                    ...
                    try{
                        btn = new Boton_de_Citas(btn_col*ancho_boton, btn_fila*alto_boton, ancho_boton, alto_boton, paciente,Hora_inicio_Mysql,Hora_final_Mysql, Tel, correo);
